...
import { PrivacyContent, TermsContent } from './LegalDocumentsView';

type Mode = 'login' | 'register' | 'forgot' | 'privacy' | 'terms';
...
export function AuthView() {
  ...
  async function handleRegister(e: React.FormEvent) {
    ...
    try {
      ...
      setSuccess('Conta criada. Complete sua ficha de inscrição.');
    } catch (err) {
      setError(getAuthErrorMessage(err));
    } finally {
      setLoading(false);
  ...
  return (
    <div className="auth-page">
      <div className="auth-card">
        <div className="brand">
          <h1>FORJADOS</h1>
          <p>SISTEMA DE EQUIPE</p>
        </div>

        {mode === 'login' && (
          <form onSubmit={handleLogin} className="form">
            <h2>Acesso ao Campo</h2>
        ...
        {mode === 'register' && (
          <form onSubmit={handleRegister} className="form">
            ...
            <button className="primary-button" disabled={loading}>
              {loading ? 'Criando...' : 'Começar cadastro'}
            </button>
        ...
        {mode === 'privacy' && (
          <div className="form legal-auth-view">
            <PrivacyContent />
