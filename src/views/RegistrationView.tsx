  ...
  return (
    <div className="page-center">
      <form className="panel wide" onSubmit={handleSubmit}>
        ...
        <p className="muted">Complete sua ficha para análise da diretoria.</p>
        ...
        <div className="grid two">
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) => setForm({ ...form, requested_role: e.target.value as UserRole })}
            >
        ...
        <div className="grid two">
          <div>
            ...
            <input
              ...
              onChange={(e) => setForm({ ...form, specific_function: e.target.value })}
            />
          </div>
        ...
        <div className="grid two">
          <div>
            ...
            <input
              ...
              onChange={(e) => setForm({ ...form, food_restrictions: e.target.value })}
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => setForm({ ...form, health_problems: e.target.value })}
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => setForm({ ...form, continuous_medicine: e.target.value })}
            />
          </div>
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) => setForm({ ...form, has_vehicle: e.target.value === 'sim' })}
            >
        ...
        <div className="terms">
          <label>
            <input
              ...
              onChange={(e) => setForm({ ...form, privacyPolicy: e.target.checked })}
            />
            Li e aceito a Política de Privacidade do aplicativo FORJADOS.
          </label>
          ...
          <label>
            <input
              ...
              onChange={(e) => setForm({ ...form, responsibilityTerm: e.target.checked })}
            />
            Li e aceito o Termo de Responsabilidade, autorizo o uso das informações para organização da equipe e declaro que os dados informados são verdadeiros.
          </label>
        </div>
