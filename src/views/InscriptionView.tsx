  ...
  return (
    <div className="inscription-page">
      ...
      <section className="inscription-grid">
        ...
        <div className="card inscription-card"><h3>Retiros participados</h3><strong>{profile.retreat_count_manual ?? profile.retreat_count ?? 0}</strong><p className="muted">Atualizado automaticamente quando a inscrição é confirmada pela tesouraria. O admin pode ajustar se necessário.</p></div>
      </section>
